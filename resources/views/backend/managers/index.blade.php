    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">All Managers
                    <span class="text-muted pt-2 font-size-sm d-block">This table shows all managers stored in the
                        system</span>
                </h3>
            </div>
            <div class="card-toolbar">
                ...
                <!--end::Dropdown-->
                <!--begin::Button-->
                <a href="{{ route('managers.create') }}" class="btn btn-primary font-weight-bolder">
                    <span class="svg-icon svg-icon-md">
        ...
        @livewire('manager-search-livewire', [
            'managers' => $managers,
        ])
    </div>
@endsection
...
@section('scripts')
    <script>
        ...
        function blockManager(id) {
            ...
            constmanager.report.xlsx xhr = new XMLHttpRequest();
            xhr.open("GET", URL + 'managers/' + id);
            xhr.send();
        ...
        function interactWithModal(response) {
            if (response) {
                document.getElementById('modal-block-title').innerHTML = 'Info: ' + response.manager.fname + " " + response
                    .manager.lname;
        ...
        function blockAdmin(position = 'manager') {
            ...
            axios.post('/auto/block/' + response.manager.id + '/' + position, formData)
