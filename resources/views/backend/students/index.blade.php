...
@section('content')
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">All Students
                    <span class="text-muted pt-2 font-size-sm d-block">This table shows all students stored in the
                        system</span>
                </h3>
            </div>
        ...
        @livewire('student-search-livewire', [
            'students' => $students,
        ])
    </div>
@endsection
...
@section('scripts')
    <script>
        ...
        function interactWithModal(response) {
            if (response) {
                document.getElementById('modal-block-title').innerHTML = 'Info: ' + response.student.fname + " " + response
                    .student.lname;
        ...
        function blockAdmin(position = 'student') {
            ...
            axios.post('/auto/block/' + response.student.id + '/' + position, formData)
