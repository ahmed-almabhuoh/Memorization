...
@section('title', 'All ' . $student->fname . ' keeps')
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">All {{$student->fname }} keeps
                    <span class="text-muted pt-2 font-size-sm d-block">This table shows all Keeps stored in the
                        system related to {{$student->fname}} student</span>
                </h3>
            </div>
