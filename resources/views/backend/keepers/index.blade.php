    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">All Keepers
                    <span class="text-muted pt-2 font-size-sm d-block">This table shows all keepers stored in the
                        system</span>
                </h3>
            </div>
            <div class="card-toolbar">
                ...
                <!--end::Dropdown-->
                <!--begin::Button-->
                <a href="{{ route('keepers.create') }}" class="btn btn-primary font-weight-bolder">
                    <span class="svg-icon svg-icon-md">
        ...
        @livewire('keeper-search-livewire', [
            'keepers' => $keepers,
        ])
    </div>
@endsection
...
@section('scripts')
    <script>
        ...
        function interactWithModal(response) {
            if (response) {
                document.getElementById('modal-block-title').innerHTML = 'Info: ' + response.keeper.fname + " " + response
                    .keeper.lname;
        ...
        function blockAdmin(position = 'keeper') {
            ...
            axios.post('/auto/block/' + response.keeper.id + '/' + position, formData)
