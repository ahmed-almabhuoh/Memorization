            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter supervisor first name ..." id="fname"
                        value="{{ $supervisor->fname }}" />
                </div>

                <div class="form-group">
                    <label>Second name <span class="text-danger">*</span></label>
                    <input type="text" value="{{ $supervisor->sname }}" class="form-control"
                        placeholder="Enter supervisor second name ..." id="sname" />
                </div>

                <div class="form-group">
                    <label>Third name <span class="text-danger">*</span></label>
                    <input type="text" value="{{ $supervisor->tname }}" class="form-control"
                        placeholder="Enter supervisor third name ..." id="tname" />
                </div>

                <div class="form-group">
                    <label>Last name <span class="text-danger">*</span></label>
                    <input type="text" value="{{ $supervisor->lname }}" class="form-control"
                        placeholder="Enter supervisor last name ..." id="lname" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $supervisor->phone }}"
                        placeholder="Enter supervisor phone No. ..." id="phone" />
                    <span class="form-text text-muted">We'll never share your Phone No. with anyone else.</span>
                </div>

                <div class="form-group">
                    <label>Email <span class="text-danger">*</span></label>
                    <input type="email" class="form-control" value="{{ $supervisor->email }}"
                        placeholder="Enter supervisor email ..." id="email" />
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="gender">
                        <option value="0">-- Select supervisor gender --</option>
                        @foreach (App\Models\User::GENDER as $gender)
                            <option value="{{ $gender }}" @if ($supervisor->gender == $gender) selected @endif>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="status">
                        <option value="0">-- Select supervisor account status --</option>
                        @foreach (App\Models\User::STATUS as $status)
                            <option value="{{ $status }}" @if ($supervisor->status == $status) selected @endif>
                ...
                <div class="form-group">
                    ...
                    <span class="form-text text-muted">If you do not need to change supervisor password, let this field
                        empty.</span>
                </div>

                <div class="form-group  mb-1 row supervisor-image">
                    ...
                    <div class="col-9">
                        <div class="image-input image-input-empty image-input-outline" id="kt_user_edit_avatar"
                            style="background-image: url('{{ Storage::url($supervisor->image) }}')">
                ...
                <div class="form-group mb-1">
                    ...
                    <textarea class="form-control" id="local_region" rows="3">{{ $supervisor->local_region }}</textarea>
                </div>
...
@section('scripts')
    <script>
        function skip() {
            window.location.href = '/auto/supervisors';
        }
        ...
        function update(id) {
            ...
            axios.post('/auto/supervisors/' + id, formData)
