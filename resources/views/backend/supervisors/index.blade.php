    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">All Supervisors
                    <span class="text-muted pt-2 font-size-sm d-block">This table shows all supervisors stored in the
                        system</span>
                </h3>
            </div>
            <div class="card-toolbar">
                ...
                <div class="dropdown dropdown-inline mr-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                        ...
                        <ul class="navi flex-column navi-hover py-2">
                            ...
                            <li class="navi-item">
                                <a href="{{ route('position.report.xlsx', 'position') }}" class="navi-link">
                                    <span class="navi-icon">
                ...
                <!--end::Dropdown-->
                <!--begin::Button-->
                <a href="{{ route('supervisors.create') }}" class="btn btn-primary font-weight-bolder">
                    <span class="svg-icon svg-icon-md">
        ...
        @livewire('supervisor-search-livewire', [
...
@section('scripts')
    <script>
        ...
        function blockManager(id) {
            ...
            xhr.open("GET", URL + 'supervisors/' + id);
            xhr.send();
            ...
            xhr.onload = () => {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    toastr.error('Supervisor not found.');
                }
            };
        }
        ...
        function interactWithModal(response) {
            if (response) {
                document.getElementById('modal-block-title').innerHTML = 'Info: ' + response.supervisor.fname + " " + response
                    .supervisor.lname;
        ...
        function blockAdmin(position = 'supervisor') {
            ...
            axios.post('/auto/block/' + response.supervisor.id + '/' + position, formData)
    ...
    <script>
        ...
        function destoy(id, refrance) {
            axios.delete('/auto/supervisors/' + id)
                .then(function(response) {
                    // handle success
