            ...
            <thead class="datatable-head">
                <tr class="datatable-row" style="left: 0px;">
                    ...
                    <th data-field="CompanyName" class="datatable-cell datatable-cell-sort"><span
                            style="width: 121px;">Key</span></th>
                    <th data-field="Country" class="datatable-cell datatable-cell-sort"><span style="width: 121px;">RAT
                            Limit</span></th>
            ...
            <tbody class="datatable-body" style="">
                ...
                @foreach ($apis as $api)
                    <tr data-row="0" class="datatable-row" style="left: 0px;">
                        ...
                        <td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell"><span
                                style="width: 121px;">{{ $api->key }}</span></td>


                        <td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell"><span
                                style="width: 121px;">{{ $api->api_rat_limit }}</span></td>

                        <td data-field="Status" aria-label="6" class="datatable-cell"><span style="width: 121px;"><span
                                    class="{{ $api->api_status_class }}">{{ ucfirst($api->status) }}</span></span>
                        </td>

                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span
                                    class="label label-{{ $api->api_deletion_class }} label-dot mr-2">
                                </span>
                                <span
                                    class="font-weight-bold text-{{ $api->api_deletion_class }}">{{ $api->api_deletion }}</span>
                            </span>
                        </td>
                        ...
                        <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                            class="datatable-cell"><span style="overflow: visible; position: relative; width: 125px;">
                                ...
                                </div> <a href="{{ route('apis.edit', Crypt::encrypt($api->id)) }}"
