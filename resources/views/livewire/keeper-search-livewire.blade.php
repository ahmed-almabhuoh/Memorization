                ...
                @foreach ($keepers as $keeper)
                    <tr data-row="0" class="datatable-row" style="left: 0px;">
                        <td data-field="Country" aria-label="China" class="datatable-cell"><span
                                style="width: 121px;">{{ $keeper->full_name }}</span></td>
                        <td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell"><span
                                style="width: 121px;">
                                @if ($keeper->image)
                                    <img src="{{ Storage::url($keeper->image) }}" id="keeper-image" alt="-">
                                @else
                                    -
                                @endif
                            </span></td>
                        <td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell"><span
                                style="width: 121px;">{{ $keeper->email }}</span></td>
                        <td data-field="Status" aria-label="6" class="datatable-cell"><span style="width: 121px;"><span
                                    class="{{ $keeper->user_status_class }}">{{ ucfirst($keeper->status) }}</span></span>
                        </td>
                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span class="label label-primary label-dot mr-2"></span><span
                                    class="{{ $keeper->user_gender_class }}">{{ ucfirst($keeper->gender) }}</span></span>
                        </td>


                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span
                                    class="label label-{{ $keeper->user_deletion_class }} label-dot mr-2">
                                </span>
                                <span
                                    class="font-weight-bold text-{{ $keeper->user_deletion_class }}">{{ $keeper->user_deletion }}</span>
                            </span>
                        </td>
                        ...
                        <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                            class="datatable-cell"><span style="overflow: visible; position: relative; width: 125px;">
                                <div class="dropdown dropdown-inline"> <a href="javascript:;"
                                        ...
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item"> <a
                                                    href="{{ route('user.blocks', [
                                                        'blocked_id' => Crypt::encrypt($keeper->id),
                                                        'guard' => 'keeper',
                                                    ]) }}"
                                            ...
                                            <li class="navi-item">
                                                <a onclick="blockManager('{{ Crypt::encrypt($keeper->id) }}')"
                                            ...
                                            <li class="navi-item"> <a
                                                    href="{{ route('user.report.xlsx', Crypt::encrypt($keeper->id)) }}"
                                                    class="navi-link"> <span class="navi-icon"><i
                                ...
                                </div> <a href="{{ route('keepers.edit', Crypt::encrypt($keeper->id)) }}"
                                    ...
                                    onclick="confirmDestroy('{{ Crypt::encrypt($keeper->id) }}', this)"
                                ...
                                <div class="modal-body">
                                    <div data-scroll="true" data-height="300">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" onclick="blockAdmin('keeper')"
