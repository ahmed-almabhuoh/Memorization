                ...
                @foreach ($students as $student)
                    <tr data-row="0" class="datatable-row" style="left: 0px;">
                        ...
                        <td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell"><span
                                style="width: 121px;">
                                @if ($student->image)
                                    <img src="{{ Storage::url($student->image) }}" id="student-image" alt="-">
                                @else
                                    -
                                @endif
                            </span></td>
                        <td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell"><span
                                style="width: 121px;">{{ $student->email }}</span></td>
                        <td data-field="Status" aria-label="6" class="datatable-cell"><span style="width: 121px;"><span
                                    class="{{ $student->user_status_class }}">{{ ucfirst($student->status) }}</span></span>
                        </td>
                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span class="label label-primary label-dot mr-2"></span><span
                                    class="{{ $student->user_gender_class }}">{{ ucfirst($student->gender) }}</span></span>
                        </td>


                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span
                                    class="label label-{{ $student->user_deletion_class }} label-dot mr-2">
                                </span>
                                <span
                                    class="font-weight-bold text-{{ $student->user_deletion_class }}">{{ $student->user_deletion }}</span>
                            </span>
                        </td>
                        ...
                        <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                            class="datatable-cell"><span style="overflow: visible; position: relative; width: 125px;">
                                <div class="dropdown dropdown-inline"> <a href="javascript:;"
                                        ...
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item"> <a
                                                    href="{{ route('user.blocks', [
                                                        'blocked_id' => Crypt::encrypt($student->id),
                                                        'guard' => 'student',
                                                    ]) }}"
                                            ...
                                            <li class="navi-item">
                                                <a onclick="blockManager('{{ Crypt::encrypt($student->id) }}')"
                                            ...
                                            <li class="navi-item"> <a
                                                    href="{{ route('user.report.xlsx', Crypt::encrypt($student->id)) }}"
                                                    class="navi-link"> <span class="navi-icon"><i
                                ...
                                </div> <a href="{{ route('students.edit', Crypt::encrypt($student->id)) }}"
                                    ...
                                    onclick="confirmDestroy('{{ Crypt::encrypt($student->id) }}', this)"
                                ...
                                <div class="modal-body">
                                    <div data-scroll="true" data-height="300">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" onclick="blockAdmin('student')"
