            ...
            <tbody class="datatable-body">
                ...
                @foreach ($supervisors as $supervisor)
                    <tr data-row="0" class="datatable-row" style="left: 0px;">
                        ...
                        <td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell"><span
                                style="width: 121px;">{{ $supervisor->email }}</span></td>
                        <td data-field="Status" aria-label="6" class="datatable-cell"><span style="width: 121px;"><span
                                    class="{{ $supervisor->user_status_class }}">{{ ucfirst($supervisor->status) }}</span></span>
                        </td>
                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span class="label label-primary label-dot mr-2"></span><span
                                    class="{{ $supervisor->user_gender_class }}">{{ ucfirst($supervisor->gender) }}</span></span>
                        </td>


                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span
                                    class="label label-{{ $supervisor->user_deletion_class }} label-dot mr-2">
                                </span>
                                <span
                                    class="font-weight-bold text-{{ $supervisor->user_deletion_class }}">{{ $supervisor->user_deletion }}</span>
                            </span>
                        </td>
                        ...
                        <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                            class="datatable-cell"><span style="overflow: visible; position: relative; width: 125px;">
                                <div class="dropdown dropdown-inline"> <a href="javascript:;"
                                        ...
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item"> <a
                                                    href="{{ route('user.blocks', [
                                                        'blocked_id' => Crypt::encrypt($supervisor->id),
                                                        'guard' => 'supervisor',
                                                    ]) }}"
                                            ...
                                            <li class="navi-item">
                                                <a onclick="blockManager('{{ Crypt::encrypt($supervisor->id) }}')"
                                            ...
                                            <li class="navi-item"> <a
                                                    href="{{ route('user.report.xlsx', Crypt::encrypt($supervisor->id)) }}"
                                                    class="navi-link"> <span class="navi-icon"><i
                                ...
                                </div> <a href="{{ route('supervisors.edit', Crypt::encrypt($supervisor->id)) }}"
                                    ...
                                    onclick="confirmDestroy('{{ Crypt::encrypt($supervisor->id) }}', this)"
                                ...
                                <div class="modal-body">
                                    <div data-scroll="true" data-height="300">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" onclick="blockAdmin('supervisor')"
