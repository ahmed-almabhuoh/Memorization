                ...
                @foreach ($parents as $parent)
                    <tr data-row="0" class="datatable-row" style="left: 0px;">
                        <td data-field="Country" aria-label="China" class="datatable-cell"><span
                                style="width: 121px;">{{ $parent->full_name }}</span></td>
                        <td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell"><span
                                style="width: 121px;">
                                @if ($parent->image)
                                    <img src="{{ Storage::url($parent->image) }}" id="student_parent-image" alt="-">
                                @else
                                    -
                                @endif
                            </span></td>
                        <td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell"><span
                                style="width: 121px;">{{ $parent->email }}</span></td>
                        <td data-field="Status" aria-label="6" class="datatable-cell"><span style="width: 121px;"><span
                                    class="{{ $parent->user_status_class }}">{{ ucfirst($parent->status) }}</span></span>
                        </td>
                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span class="label label-primary label-dot mr-2"></span><span
                                    class="{{ $parent->user_gender_class }}">{{ ucfirst($parent->gender) }}</span></span>
                        </td>


                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span
                                    class="label label-{{ $parent->user_deletion_class }} label-dot mr-2">
                                </span>
                                <span
                                    class="font-weight-bold text-{{ $parent->user_deletion_class }}">{{ $parent->user_deletion }}</span>
                            </span>
                        </td>
                        ...
                        <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                            class="datatable-cell"><span style="overflow: visible; position: relative; width: 125px;">
                                <div class="dropdown dropdown-inline"> <a href="javascript:;"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item"> <a
                                                    href="{{ route('user.report.xlsx', Crypt::encrypt($parent->id)) }}"
                                                    class="navi-link"> <span class="navi-icon"><i
                                ...
                                </div> <a href="{{ route('parents.edit', Crypt::encrypt($parent->id)) }}"
                                    ...
                                    onclick="confirmDestroy('{{ Crypt::encrypt($parent->id) }}', this)"
                                ...
                                <div class="modal-body">
                                    <div data-scroll="true" data-height="300">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" onclick="blockAdmin('student_parent')"
