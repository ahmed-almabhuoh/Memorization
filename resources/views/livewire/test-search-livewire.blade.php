<div class="card-body">
    ...
    <!--begin::Search Form-->
    <div class="mb-7">
        <div class="row align-items-test">
            ...
            @foreach ($tests as $test)
                <tr data-row="0" class="datatable-row" style="left: 0px;">
                    <td data-field="Country" aria-label="China" class="datatable-cell"><span
                            style="width: 121px;">{{ $test->type }}</span></td>
                    ...
                    <td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell"><span
                            style="width: 121px;">{{ $test->keeper_id }}</span></td>
                    {{--<td data-field="Status" aria-label="6" class="datatable-cell"><span style="width: 121px;"><span
                                class="{{ $test->center_status_class }}">{{ ucfirst($test->status) }}</span></span>
                    </td>--}}
                    <td data-field="Status" aria-label="6" class="datatable-cell"><span style="width: 121px;"><span
                                class="">{{ ucfirst($test->student_id) }}</span></span>
                    </td>

                    {{--<td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span
                                    class="label label-{{ $test->center_deletion_class }} label-dot mr-2">
                                </span>
                                <span
                                    class="font-weight-bold text-{{ $test->center_deletion_class }}">{{ $test->center_deletion }}</span>
                            </span>
                    </td>--}}
                    ...
                    <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span
                                ...
                                <span
                                    class="font-weight-bold text-success">{{ $test->mark }}</span>
                            </span>
                    </td>
                    ...
                    <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                        class="datatable-cell"><span style="overflow: visible; position: relative; width: 125px;">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item"> <a
                                                    href="{{ route('test.report.xlsx', Crypt::encrypt($test->id)) }}"
                                ...
                                </div> <a href="{{ route('tests.edit', Crypt::encrypt($test->id)) }}"
                                            ...
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                ...
                                                <rect fill="#000000" opacity="0.3" x="5" y="20"
                                                      width="15" height="2" rx="1">
                                                                    ...
                                                                    onclick="confirmDestroy('{{ Crypt::encrypt($test->id) }}', this)"
