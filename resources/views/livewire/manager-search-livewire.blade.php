            ...
            @foreach ($managers as $manager)
                <tr data-row="0" class="datatable-row" style="left: 0px;">
                    ...
                    <td data-field="Status" aria-label="6" class="datatable-cell"><span style="width: 121px;"><span
                                class="{{ $manager->user_status_class }}">{{ ucfirst($manager->status) }}</span></span>
                    </td>
                    <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span class="label label-primary label-dot mr-2"></span><span
                                    class="{{ $manager->user_gender_class }}">{{ ucfirst($manager->gender) }}</span></span>
                    </td>


                    <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span
                                    class="label label-{{ $manager->user_deletion_class }} label-dot mr-2">
                                </span>
                                <span
                                    class="font-weight-bold text-{{ $manager->user_deletion_class }}">{{ $manager->user_deletion }}</span>
                            </span>
                    </td>
...
{{--                                            <li class="navi-item">--}}
{{--                                                <a onclick="blockManager('{{ Crypt::encrypt($manager->id) }}')"--}}
...
{{--                                            </li>--}}
                                            <li class="navi-item"> <a
                                                    href="{{ route('user.report.xlsx', Crypt::encrypt($manager->id)) }}"
                                                    class="navi-link"> <span class="navi-icon"><i
                                            ...
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                ...
                                                <rect fill="#000000" opacity="0.3" x="5" y="20"
                                                      width="15" height="2" rx="1">
                                                                    ...
                                                                    onclick="confirmDestroy('{{ \Illuminate\Support\Facades\Crypt::encrypt($manager->id) }}', this)"
                            ...
                            <div class="modal-body">
                                <div data-scroll="true" data-height="300">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" onclick="blockAdmin('manager')"
