                    ...
                    <ul class="menu-nav">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('managers.index') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">All managers</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('supervisors.create') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">Add new supervisor</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('supervisors.index') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">All supervisors</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Keepers</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu" kt-hidden-height="80"
                                 style="display: none; overflow: hidden;">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('keepers.create') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add new keeper</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('keepers.index') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">All keepers</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu" kt-hidden-height="80"
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('parents.create') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add new parent</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('parents.index') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">All parents</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-section">
                            <h4 class="menu-text">CM - Content Management</h4>
                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu" kt-hidden-height="80"
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('supervision_committees.create') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add new SC</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('supervision_committees.index') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">All SCs</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('centers.create') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">Add new center</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('centers.index') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">All centers</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu" kt-hidden-height="80"
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('tests.create') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">New Test</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('tests.index') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('reports.create') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">Submit new report</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu" kt-hidden-height="80"
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('apis.create') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add new API</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ route('apis.index') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">All APIs</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="topbar">
                                ...
                                <ul class="navi navi-hover py-4">
                                    ...
                                    <li class="navi-item active">
                                        <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img
                                                        src="{{ asset('backend/assets/media/svg/flags/128-spain.svg') }}"
                                                        alt=""/>
                                                </span>
                                    ...
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img
                                                        src="{{ asset('backend/assets/media/svg/flags/162-germany.svg') }}"
                                                        alt=""/>
                                                </span>
                                    ...
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img
                                                        src="{{ asset('backend/assets/media/svg/flags/063-japan.svg') }}"
                                                        alt=""/>
                                                </span>
                                    ...
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img
                                                        src="{{ asset('backend/assets/media/svg/flags/195-france.svg') }}"
                                                        alt=""/>
                                                </span>
                        ...
                        <div class="topbar-item">
                            <div
                                ...
                                <span
                                    class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">John</span>
            ...
            <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                ...
                <div
                    ...
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="#" target="_blank" class="text-dark-75 text-hover-primary">Automation
                            Recored System</a>
                    </div>
                    <!--end::Copyright-->
                    <!--begin::Nav-->
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 class="font-weight-bold m-0">User Profile
            <small class="text-muted font-size-sm ml-2">Last Login</small>
        </h3>
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">John
                    John</a>
                ...
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
                            <span class="navi-link p-0 pb-2">
                                ...
                                <span class="navi-text text-muted text-hover-primary">email@auto.com</span>
                            </span>
                    </a>
                    <a href="{{ route('logout') }}"
